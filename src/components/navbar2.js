      ...
      <header data-thq="thq-navbar" className="navbar2-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar2-desktop-menu">
          <nav className="navbar2-links">
            ...
            <Link to="/beats" className="navbar2-link3 thq-link thq-body-small">
              {props.link3}
            </Link>
            <span className="navbar2-link4 thq-link thq-body-small">
              {props.link4}
            </span>
            <Link
              to="/download"
              className="navbar2-link5 thq-link thq-body-small"
            >
              {props.link5}
            </Link>
          </nav>
        ...
        <div data-thq="thq-mobile-menu" className="navbar2-mobile-menu">
          <div className="navbar2-nav">
            ...
            <nav className="navbar2-links1">
              <span className="thq-link thq-body-small navbar2-link11">
                {props.link1}
              </span>
              <span className="thq-link thq-body-small navbar2-link21">
                {props.link2}
              </span>
              <span className="thq-link thq-body-small navbar2-link31">
                {props.link3}
              </span>
              <span className="thq-link thq-body-small navbar2-link41">
                {props.link4}
              </span>
              <span className="thq-link thq-body-small navbar2-link51">
                {props.link5}
              </span>
            </nav>
          </div>
