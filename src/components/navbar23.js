...
const Navbar23 = (props) => {
  return (
    <header className={`navbar23-container ${props.rootClassName} `}>
      <header data-thq="thq-navbar" className="navbar23-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar23-desktop-menu">
          <nav className="navbar23-links">
            <span className="navbar23-link1 thq-link thq-body-small">
              {props.link1}
            </span>
            <span className="navbar23-link2 thq-link thq-body-small">
              {props.link2}
            </span>
            <span className="navbar23-link3 thq-link thq-body-small">
              {props.link3}
            </span>
            <span className="navbar23-link4 thq-link thq-body-small">
              {props.link4}
            </span>
            <span className="navbar23-link5 thq-link thq-body-small">
              {props.link5}
            </span>
          </nav>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="navbar23-mobile-menu">
          <div className="navbar23-nav">
            ...
            <nav className="navbar23-links1">
              <span className="thq-link thq-body-small navbar23-link11">
                {props.link1}
              </span>
              <span className="thq-link thq-body-small navbar23-link21">
                {props.link2}
              </span>
              <span className="thq-link thq-body-small navbar23-link31">
                {props.link3}
              </span>
              <span className="thq-link thq-body-small navbar23-link41">
                {props.link4}
              </span>
              <span className="thq-link thq-body-small navbar23-link51">
                {props.link5}
              </span>
            </nav>
          </div>
...
Navbar23.defaultProps = {
  link2: 'Link2',
  link1: 'Link1',
  logoSrc: '7ac2e20b-dba7-443a-ae25-bd0d2c8ed115',
  logoAlt: 'logo',
  link3: 'Link3',
  rootClassName: '',
  link5: 'Link5',
